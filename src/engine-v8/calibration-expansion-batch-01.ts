 ...
 *
 * These are design/runtime contracts only. They intentionally contain no V7 dice target,
 * reroll or left/centre/right-sector language. Tracker identity is preserved while obsolete
 * consequences are translated to the V8 DEF/MID/ATT + generated-Tactical grammar.
 */
