...
export type MatchEvent =
  | { type: 'match-start'; seed: number; postures: [Posture, Posture]; target: number }
  ...
  | { type: 'points-banked'; side: Side; source: 'goal' | 'accrual'; mult: number; value: number; total: number; clock: Clock }
