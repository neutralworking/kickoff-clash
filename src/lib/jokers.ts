...
export const ALL_JOKERS: JokerCard[] = [
  {
    ...
    nation: 'England',
    effect: 'Your forwards +2 ATK — raises FINISH.',
  ...
  },
  {
    ...
    nation: 'France',
    effect: 'Your ball-players +2 ATK — raises KEEP.',
  ...
  },
  {
    ...
    nation: 'Portugal',
    effect: 'Your back line +2 DEF — raises STOP.',
  ...
  },
  {
    ...
    traits: ['Organised Press', 'High Press'],
    nation: 'Germany',
    effect: 'Your front line +2 DEF — raises PRESS.',
